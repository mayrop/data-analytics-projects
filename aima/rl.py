...
def run_single_trial(agent_program, mdp, max_iterations=0):
    ...
    i = 0
    while True and (not max_iterations or i < max_iterations):
        i += 1
        ...
        if next_action is None:
            agent_program(percept)
            break

        current_state = take_single_action(mdp, current_state, next_action)

    # added....
    return current_reward, i