...
```{r, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, fig.align = "center", fig.height = 3, fig.width = 10, out.width = '90%'}
...
grid.arrange(
  fix_caption(u_plot(lakes[[4]][[1]])) + labs(caption = "Problem 0 - Utilities Table"),
  fix_caption(u_plot(lakes[[4]][[2]])) + labs(caption = "Problem 1 - Utilities Table"),
  fix_caption(u_plot(lakes[[4]][[3]])) + labs(caption = "Problem 2 - Utilities Table"),
  fix_caption(u_plot(lakes[[4]][[4]])) + labs(caption = "Problem 3 - Utilities Table"),
  ncol=4
)
```

```{r lakes3, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, fig.align = "center", fig.height = 4, fig.width = 8, out.width = '85%'}
