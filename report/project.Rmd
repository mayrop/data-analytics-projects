...
```{r lakes3, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE, fig.align = "center", fig.height = 4, fig.width = 8, out.width = '100%'}
margin = theme(plot.margin = unit(c(2,2,2,2), "cm"))

grid.arrange(
  fix_caption(remove_legend(finish_plot(ggplot(lakes[[8]][[1]], aes(x_grid, y_grid))))) + 
    labs(caption = "8x8 Grid Problem 0"),
  fix_caption(u_plot(lakes[[8]][[1]])) + labs(caption = "8x8 Grid Problem 0"),
  ncol=2
)
